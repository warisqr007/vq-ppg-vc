...
class Transformer(TTSInterface, torch.nn.Module):
    ...
    def __init__(self,args):
        ...
        self.prosody_encoder = ProsodyEncoder(80, self.prosody_emb_dim) #ECAPA_TDNN()
    ...
    def forward(self, xs, ilens, ys, olens, spembs=None, prosody_vec=None, *args, **kwargs):
        ...
        # prosody_embs = self.prosody_encoder(prosody_vec.transpose(1,2))
    ...
    def inference(self, x, spemb=None, prosody_vec=None, *args, **kwargs):
        ...
        # hs = self.prosody_spk_projection(torch.cat([hs, spembs], dim=-1))
